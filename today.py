...
if __name__ == '__main__':
    """
    Shayan Ghori (ShayanAkhun)
    Based on Andrew Grant's (Andrew6rant) profile README generator
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2000, 2, 21))
